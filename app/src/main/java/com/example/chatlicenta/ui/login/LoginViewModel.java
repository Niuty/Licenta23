...
public class LoginViewModel extends ViewModel {
    ...
    public void login(String username, String password) {
        ...
        if (result instanceof Result.Success) {
            ...
            // ----- BEGIN updated: include userId in LoggedInUserView -----
            // old: new LoggedInUserView(data.getDisplayName())
            LoggedInUserView view = new LoggedInUserView(data.getUserId(), data.getDisplayName());
            loginResult.setValue(new LoginResult(view));
            // ----- END updated -----
        } else {
